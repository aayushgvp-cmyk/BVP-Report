	...
	if(FROM2=="All"){return true}
		...
		switch(FROM2){
			...
			case 7:
				...
				if(DATE_TODAY_IN_yyyymmdd>D&&D>=D3){return true}
				else{return false} 
				break;
			case 8:
...
function FilterAndReload2(newdata,Variable){
	let NEWDATAOBJECT={};newdata.forEach(r=>{if(!(r[COL1[Variable]] in NEWDATAOBJECT)){NEWDATAOBJECT[r[COL1[Variable]]]=0};NEWDATAOBJECT[r[COL1[Variable]]]+=1})
